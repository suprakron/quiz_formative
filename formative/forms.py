...
class CreateQuestionForm(forms.Form):
    ...
    choice1_text = forms.CharField(
        max_length=300, label="Choice 1", widget=forms.TextInput(attrs={'class': 'choice_box'}))
    ...
    choice2_text = forms.CharField(
        max_length=300, label="Choice 2", widget=forms.TextInput(attrs={'class': 'choice_box'}))
    ...
    choice3_text = forms.CharField(
        max_length=300, label="Choice 3", widget=forms.TextInput(attrs={'class': 'choice_box'}))
    ...
    choice4_text = forms.CharField(
        max_length=300, label="Choice 4", widget=forms.TextInput(attrs={'class': 'choice_box'}))
